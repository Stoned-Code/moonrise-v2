...
namespace ActionMenuAPI
{
    public class ActionMenuApi
    {
        ...
        {
            harmonyInstance = new HarmonyLib.Harmony(typeof(ActionMenuApi).Namespace.ToString() + ".ActionMenuApi");
            ...
            {
                //MelonLogger.Msg("Found Main Page: " + methodBase.Name);
        ...
        /*
        public class PedalRadialPuppetStruct :P
        {
            public string text { get; set; }
            public Texture2D icon { get; set; }
            public System.Action triggerEvent { get; set; }
            public float value { get; set; }
            public PedalRadialPuppetStruct(string text, Texture2D icon, System.Action triggerEvent)
            {
                this.text = text;
                this.icon = icon;
                this.triggerEvent = triggerEvent;
